...
if(!empty($project_name) && !empty($project_details) && !empty($project_group_name)  && !empty($student1) && !empty($student2) && !empty($student3)){
    ...
    $sql="INSERT INTO projectDetails(project_name,project_details,project_group_name,student1,student2,student3,student4,status) values ('$project_name','$project_details','$project_group_name',$student1,$student2,$student3,$user_id,'$status')";
